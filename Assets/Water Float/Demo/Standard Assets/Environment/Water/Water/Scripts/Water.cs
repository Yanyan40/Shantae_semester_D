...
namespace UnityStandardAssets.Water
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        // This is called when it's known that the object will be rendered by some camera.
        public void OnWillRenderObject()
        {
            ...
            // Actual water rendering mode depends on both the current setting AND the hardware support.
        ...
        // This just sets up some matrices in the material; for really old cards to make water texture scroll.
        void Update()
        {
            ...
            if (mat.HasProperty("WaveSpeed") && mat.HasProperty("_WaveScale")) // Check if the material has the required properties
            {
